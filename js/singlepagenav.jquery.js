    ...
    var plugin = {
      ...
      get_current_section: function() {
        ...
        $.each(this.sections, function() {
          ...
          var end = start + this.outerHeight() + parseInt(offset) + settings.currentThreshold;
      ...
      /*bind_click: function() {
        ...
        this.html.find('a[href^="#"]').bind('click', function (event) {
          ...
          if (typeof section[0].dataset.offset !== "undefined") {
            var offset = section[0].dataset.offset;
          } else {
            var offset = settings.offset;
          }
          ...
          var scroll = position.top - offset;
      ...
      initialize: function () {
        ...
        var link = this.menu.find('li.last a');
        link.addClass(settings.currentClass);
      }
    }
